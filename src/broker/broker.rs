...
use crate::decode::packet::{Packet, CURRENT_VERSION};
...
fn run_jobs(b: &Broker, mut client: TcpStream, jobs: Jobs) {
    loop {
...
async fn worker_process_slice_request(
    ...
    match packet.write_cells_from_set(client, params, cells).await {
